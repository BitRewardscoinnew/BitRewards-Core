    ...
    nWeight(0)
{
    ...
    setStyleSheet("#Bitrewards { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 2.4, stop: 0 #0066af, stop: 1 #ffffff);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
    ...
    statusBar()->setStyleSheet("#statusBar { color: #ffffff; background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 0.6, stop: 0 #101010, stop: 1 #875ebc);  }");
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #ffffff; font-size: 14px; font-weight: 400; font-variant: small-caps; padding: 3px; border: none;}"
                           "QToolButton:hover { background-color: #875ebc; border-radius: 3px; padding-top: 3px; padding-bottom: 3px; }"
                           "QToolButton:checked { background-color: #875ebc; border-radius: 3px; padding-top: 3px; padding-bottom: 3px; }"
                           "QToolButton:pressed { background-color: #875ebc; border-radius: 3px; padding-top: 3px; padding-bottom: 3px; }"
...
{
    if(!fOnlyTor)
    netLabel->setText("BitRewards Network");
    else
    {
