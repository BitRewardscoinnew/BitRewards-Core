...
public:
    CMainParams() {
       ...
       // vAlertPubKey = ParseHex("0424d4d59ad30c33510d2597aef881965e079ca1d42778199bb20ac40f1a19e7e28db32422464e51c35fc41672f2d64ff5aba85f573fefc351515d5b3b4e6143ee");
	    ...
	    vSeeds.push_back(CDNSSeedData("1", "seed.bitrewards.io"));
	    ...
	    vSeeds.push_back(CDNSSeedData("185.22.172.14", "185.22.172.14")); //SINGLE NODE ADDRESS	
	    vSeeds.push_back(CDNSSeedData("140.82.52.251", "140.82.52.251")); //SINGLE NODE ADDRESS	
		
        convertSeeds(vFixedSeeds, pnSeed, ARRAYLEN(pnSeed), nDefaultPort);

        nPoolMaxTransactions = 3;
        strDarksendPoolDummyAddress = "XcGnHb1axAfEqy5ph1TiBn4968DzymVTnv";
        nLastPOWBlock = 999999999;  //POW will go on forever
        nPOSStartBlock = 2;
    }
